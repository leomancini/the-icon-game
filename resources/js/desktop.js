// setup / booting / debug
var base_image_url = "https://cdn.glitch.com/9920a9c9-30b6-4f69-b49c-f6141ca56fb3%2F";
...
function make_windows_draggable() {
	...
	$(".window .window-controls").click(function() {
		...
		if($(this).closest(".window").attr("id") == "finder") {
			$(".menu-bar-item#score-wrapper").addClass("active"); setTimeout(function() {
...
$(document).ready(function() {
	...
	$(".slider.velocity").val(game.position_change_per_second_default).on("change mousemove", function() {  // variable defined in game.js
	...
	if(event.target.id == "icons" || event.target.className == "icon caught") {
		$(".window").not("#streak-notification").addClass("background").removeClass("foreground");
